...
<div class="companyNameSpace">
    <h1 class="comapanyName"><a class="linkCompanyName" href="<?= base_url_php(); ?>home"><img src="<?= base_url(); ?>img/Banner_TCC/logoPadrao.png" alt=""></a></h1>
</div>
...
<ul class="menuTopNav">
    ...
    <li class="celulaTopNav">
        <a class="linkMenuTopNav" href="<?= base_url_php(); ?>compra/carrinho">
            <div class="leftBack">
...
<ul class="menuTopNavMobile">
  ...
  <li class="celulaTopNavMobile"><a class="linkMenuTopNavMobile" href="<?= base_url_php(); ?>compra/carrinho"><i class="fas fa-shopping-cart"></i></a></li>
</ul>